...
OUTPUT_TRANSFORM_FILE = "temp_recovered.csv"
COLUMNS = ["province",
           "country",
           "lat",
           "lon",
...
dag = DAG('recovered_covid_dag', description='Recovered cases Covid-19.',
         default_args={
            'owner':'josef.perez',
...
def insert_process(**kwargs):
    ...
    with db_connection.begin() as transaction:
        transaction.execute("DELETE FROM proyecto_pd.covid19_recovered WHERE 1=1")
        source_df.to_sql("covid19_recovered", con=transaction,
